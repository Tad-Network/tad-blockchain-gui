...
import { Card, CopyToClipboard, Flex, Table } from '@tad/core';
  ...
  },
  {
    field: (row: Row) =>
      type === WalletType.COLOURED_COIN
        ? mtad_to_colouredcoin_string(row.amount)
        : mtad_to_tad_string(row.amount),
    title: <Trans>Amount</Trans>,
  },
  {
    field: (row: Row) => mtad_to_tad_string(row.fee_amount),
