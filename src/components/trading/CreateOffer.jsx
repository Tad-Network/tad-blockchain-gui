...
import { tad_to_mtad, colouredcoin_to_mtad } from '../../util/tad';
  ...
  function handleAdd() {
    ...
    const mtad =
      wallets[wallet_id.value].type === COLOURED_COIN
        ? colouredcoin_to_mtad(amount_input.value)
        : tad_to_mtad(amount_input.value);

    const trade =
      buy_or_sell.value === 1
        ? newBuy(mtad, wallet_id.value)
        : newSell(mtad, wallet_id.value);
